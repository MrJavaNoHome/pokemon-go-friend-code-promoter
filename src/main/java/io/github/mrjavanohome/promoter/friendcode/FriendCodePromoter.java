package io.github.mrjavanohome.promoter.friendcode;
...
//TODO not working cause of reCaptchaV2
public class FriendCodePromoter implements Promoter {

   private final Logger log = Logger.getLogger(getClass().getSimpleName());
   private final String uri = "https://europe-west3-friend-code.cloudfunctions.net/api/code";
   ...
   private void promote(String code) throws IOException {
      try (final CloseableHttpClient httpClient = httpClientProvider.createClient()) {
         final ArrayList<BasicNameValuePair> form = Lists.newArrayList(new BasicNameValuePair("code", code), new BasicNameValuePair("type", "pokemon_go"));
